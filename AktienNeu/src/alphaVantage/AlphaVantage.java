...
public class AlphaVantage {
	...
	public static TreeMap<Date,BigDecimal> getAdjustedTimeSeries(String nameSharePrice, String apiKey) throws JSONException, MalformedURLException, IOException{
		...
		String url="https://www.alphavantage.co/query?function=TIME_SERIES_DAILY_ADJUSTED&symbol="+nameSharePrice+"&outputsize=full&apikey="+apiKey;
		...
		try {
			...
			for(String date : dates) {
				BigDecimal closeValue = new BigDecimal((String) ((JSONObject) json.get(date)).get("5. adjusted close"));
